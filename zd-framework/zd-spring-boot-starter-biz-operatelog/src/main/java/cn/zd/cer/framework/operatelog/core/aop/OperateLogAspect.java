package cn.zd.cer.framework.operatelog.core.aop;
...
import cn.zd.cer.framework.operatelog.core.enums.OperateTypeEnum;
import cn.zd.cer.framework.operatelog.core.service.OperateLog;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        cn.zd.cer.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                cn.zd.cer.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         cn.zd.cer.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           cn.zd.cer.framework.operatelog.core.annotations.OperateLog operateLog,
