package cn.zd.cer.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.zd.cer.framework.social.core.enums.AuthExtendSource;
import cn.zd.cer.framework.social.core.request.AuthWeChatMiniAppRequest;
import cn.zd.cer.framework.social.core.request.AuthWeChatMpRequest;
 ...
 * @date 2021-10-31
 */
public class ZdAuthRequestFactory extends AuthRequestFactory {
    ...
    public ZdAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
