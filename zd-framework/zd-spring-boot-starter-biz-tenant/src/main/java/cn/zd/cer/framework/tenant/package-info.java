 ...
 *      1）Spring Async：
 *          {@link cn.zd.cer.framework.quartz.config.ZdAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 ZdSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.zd.cer.framework.tenant;
