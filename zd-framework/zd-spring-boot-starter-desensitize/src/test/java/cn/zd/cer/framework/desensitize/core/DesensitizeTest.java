package cn.zd.cer.framework.desensitize.core;

import cn.zd.cer.framework.common.util.json.JsonUtils;
import cn.zd.cer.framework.desensitize.core.regex.annotation.EmailDesensitize;
import cn.zd.cer.framework.desensitize.core.regex.annotation.RegexDesensitize;
import cn.zd.cer.framework.desensitize.core.annotation.Address;
import cn.zd.cer.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import cn.zd.cer.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import cn.zd.cer.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import cn.zd.cer.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import cn.zd.cer.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import cn.zd.cer.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import cn.zd.cer.framework.desensitize.core.slider.annotation.MobileDesensitize;
import cn.zd.cer.framework.desensitize.core.slider.annotation.SliderDesensitize;
