package cn.zd.cer.framework.mq.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import cn.zd.cer.framework.common.enums.DocumentEnum;
import cn.zd.cer.framework.mq.core.RedisMQTemplate;
import cn.zd.cer.framework.mq.core.interceptor.RedisMessageInterceptor;
import cn.zd.cer.framework.mq.core.pubsub.AbstractChannelMessageListener;
import cn.zd.cer.framework.mq.core.stream.AbstractStreamMessageListener;
import cn.zd.cer.framework.mq.job.RedisPendingMessageResendJob;
...
public class ZdMQAutoConfiguration {
    ...
    @ConditionalOnProperty(prefix = "zd.mq.redis.pubsub", value = "enable", matchIfMissing = true) // 允许使用 zd.mq.redis.pubsub.enable=false 禁用多租户
    ...
    @ConditionalOnProperty(prefix = "zd.mq.redis.stream", value = "enable", matchIfMissing = true) // 允许使用 zd.mq.redis.stream.enable=false 禁用多租户
