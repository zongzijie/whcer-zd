package cn.zd.cer.framework.websocket.core;
...
public class ZdWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public ZdWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
