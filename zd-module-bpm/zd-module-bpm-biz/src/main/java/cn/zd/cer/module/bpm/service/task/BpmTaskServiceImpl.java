package cn.zd.cer.module.bpm.service.task;
...
import cn.zd.cer.framework.common.util.number.NumberUtils;
import cn.zd.cer.framework.common.util.object.PageUtils;
import cn.zd.cer.framework.flowable.core.util.BpmnModelUtils;
import cn.zd.cer.framework.web.core.util.WebFrameworkUtils;
import cn.zd.cer.module.bpm.controller.admin.task.vo.task.*;
import cn.zd.cer.module.bpm.convert.task.BpmTaskConvert;
import cn.zd.cer.module.bpm.dal.dataobject.task.BpmTaskExtDO;
import cn.zd.cer.module.bpm.dal.mysql.task.BpmTaskExtMapper;
import cn.zd.cer.module.bpm.enums.task.BpmProcessInstanceDeleteReasonEnum;
import cn.zd.cer.module.bpm.enums.task.BpmProcessInstanceResultEnum;
import cn.zd.cer.module.bpm.service.definition.BpmModelService;
import cn.zd.cer.module.bpm.service.message.BpmMessageService;
