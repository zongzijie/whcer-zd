package cn.zd.cer.module.infra.controller.admin.logger.vo.apierrorlog;

import cn.zd.cer.framework.excel.core.annotations.DictFormat;
import cn.zd.cer.framework.excel.core.convert.DictConvert;
import cn.zd.cer.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(cn.zd.cer.module.system.enums.DictTypeConstants.USER_TYPE)
