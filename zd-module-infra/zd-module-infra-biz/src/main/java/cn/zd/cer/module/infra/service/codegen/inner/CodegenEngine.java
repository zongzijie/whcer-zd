package cn.zd.cer.module.infra.service.codegen.inner;
...
import cn.zd.cer.framework.common.exception.util.ServiceExceptionUtil;
...
import cn.zd.cer.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "zd-module-${table.moduleName}/" + // 顶级模块
                "zd-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "zd-module-${table.moduleName}/" + // 顶级模块
                "zd-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "zd-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "zd-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
