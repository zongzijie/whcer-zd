package cn.zd.cer.module.trade.controller.admin.config.vo;
...
import cn.zd.cer.module.trade.enums.brokerage.BrokerageWithdrawTypeEnum;
...
public class TradeConfigBaseVO {
    ...
    @Schema(description = "分销海报图地址数组", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.iocoder.cn/zd.jpg]")
