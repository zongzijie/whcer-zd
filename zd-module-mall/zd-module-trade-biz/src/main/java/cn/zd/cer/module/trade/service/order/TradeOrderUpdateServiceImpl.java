package cn.zd.cer.module.trade.service.order;
...
import cn.zd.cer.framework.common.core.KeyValue;
...
import cn.zd.cer.module.member.api.address.AddressApi;
import cn.zd.cer.module.member.api.address.dto.AddressRespDTO;
import cn.zd.cer.module.member.api.level.MemberLevelApi;
import cn.zd.cer.module.member.api.point.MemberPointApi;
...
import cn.zd.cer.module.pay.api.order.PayOrderApi;
import cn.zd.cer.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.zd.cer.module.pay.api.order.dto.PayOrderRespDTO;
import cn.zd.cer.module.pay.enums.order.PayOrderStatusEnum;
import cn.zd.cer.module.product.api.comment.ProductCommentApi;
import cn.zd.cer.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import cn.zd.cer.module.product.api.sku.ProductSkuApi;
import cn.zd.cer.module.promotion.api.bargain.BargainActivityApi;
import cn.zd.cer.module.promotion.api.bargain.BargainRecordApi;
import cn.zd.cer.module.promotion.api.combination.CombinationRecordApi;
import cn.zd.cer.module.promotion.api.combination.dto.CombinationRecordRespDTO;
import cn.zd.cer.module.promotion.api.coupon.CouponApi;
import cn.zd.cer.module.promotion.api.coupon.dto.CouponUseReqDTO;
import cn.zd.cer.module.promotion.api.seckill.SeckillActivityApi;
import cn.zd.cer.module.promotion.api.seckill.dto.SeckillActivityUpdateStockReqDTO;
import cn.zd.cer.module.promotion.enums.combination.CombinationRecordStatusEnum;
import cn.zd.cer.module.trade.controller.admin.order.vo.TradeOrderDeliveryReqVO;
import cn.zd.cer.module.trade.controller.admin.order.vo.TradeOrderRemarkReqVO;
import cn.zd.cer.module.trade.controller.admin.order.vo.TradeOrderUpdateAddressReqVO;
import cn.zd.cer.module.trade.controller.admin.order.vo.TradeOrderUpdatePriceReqVO;
import cn.zd.cer.module.trade.controller.app.order.vo.AppTradeOrderCreateReqVO;
import cn.zd.cer.module.trade.controller.app.order.vo.AppTradeOrderSettlementReqVO;
import cn.zd.cer.module.trade.controller.app.order.vo.AppTradeOrderSettlementRespVO;
import cn.zd.cer.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.zd.cer.module.trade.convert.order.TradeOrderConvert;
import cn.zd.cer.module.trade.dal.dataobject.cart.CartDO;
import cn.zd.cer.module.trade.dal.dataobject.order.TradeOrderDO;
import cn.zd.cer.module.trade.dal.dataobject.order.TradeOrderItemDO;
import cn.zd.cer.module.trade.dal.mysql.order.TradeOrderItemMapper;
import cn.zd.cer.module.trade.dal.mysql.order.TradeOrderMapper;
import cn.zd.cer.module.trade.dal.redis.no.TradeOrderNoRedisDAO;
import cn.zd.cer.module.trade.enums.ErrorCodeConstants;
import cn.zd.cer.module.trade.enums.brokerage.BrokerageRecordBizTypeEnum;
import cn.zd.cer.module.trade.enums.delivery.DeliveryTypeEnum;
import cn.zd.cer.module.trade.enums.order.*;
import cn.zd.cer.module.trade.framework.order.config.TradeOrderProperties;
import cn.zd.cer.module.trade.service.brokerage.record.BrokerageRecordService;
import cn.zd.cer.module.trade.service.brokerage.bo.BrokerageAddReqBO;
import cn.zd.cer.module.trade.service.cart.CartService;
import cn.zd.cer.module.trade.service.delivery.DeliveryExpressService;
import cn.zd.cer.module.trade.service.message.TradeMessageService;
import cn.zd.cer.module.trade.service.message.bo.TradeOrderMessageWhenDeliveryOrderReqBO;
import cn.zd.cer.module.trade.service.price.TradePriceService;
...
import static cn.zd.cer.framework.common.util.collection.CollectionUtils.*;
import static cn.zd.cer.module.pay.enums.ErrorCodeConstants.ORDER_UPDATE_PRICE_FAIL_EQUAL;
import static cn.zd.cer.module.pay.enums.ErrorCodeConstants.ORDER_UPDATE_PRICE_FAIL_PAID;
import static cn.zd.cer.module.trade.enums.ErrorCodeConstants.*;
