package cn.zd.cer.module.mp.service.message;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.StrUtil;
import cn.zd.cer.framework.common.pojo.PageResult;
import cn.zd.cer.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import cn.zd.cer.module.mp.controller.admin.message.vo.message.MpMessageSendReqVO;
import cn.zd.cer.module.mp.convert.message.MpMessageConvert;
import cn.zd.cer.module.mp.dal.dataobject.account.MpAccountDO;
import cn.zd.cer.module.mp.dal.dataobject.message.MpMessageDO;
import cn.zd.cer.module.mp.dal.dataobject.user.MpUserDO;
import cn.zd.cer.module.mp.dal.mysql.message.MpMessageMapper;
import cn.zd.cer.module.mp.enums.message.MpMessageSendFromEnum;
import cn.zd.cer.module.mp.framework.mp.core.MpServiceFactory;
import cn.zd.cer.module.mp.framework.mp.core.util.MpUtils;
import cn.zd.cer.module.mp.service.account.MpAccountService;
import cn.zd.cer.module.mp.service.material.MpMaterialService;
import cn.zd.cer.module.mp.service.message.bo.MpMessageSendOutReqBO;
import cn.zd.cer.module.mp.service.user.MpUserService;
...
import static cn.zd.cer.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
