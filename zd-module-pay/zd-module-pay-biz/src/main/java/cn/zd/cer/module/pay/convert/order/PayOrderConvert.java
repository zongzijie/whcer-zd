package cn.zd.cer.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.zd.cer.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
