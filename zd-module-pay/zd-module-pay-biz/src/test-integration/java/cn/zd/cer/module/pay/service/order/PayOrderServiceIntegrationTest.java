...
import cn.zd.cer.module.pay.service.channel.PayAppServiceImpl;
import cn.zd.cer.module.pay.service.channel.PayChannelServiceImpl;
import cn.zd.cer.module.pay.service.order.dto.PayOrderCreateReqDTO;
import cn.zd.cer.module.pay.service.order.dto.PayOrderSubmitReqDTO;
import cn.zd.cer.module.pay.test.BaseDbIntegrationTest;
import cn.zd.cer.framework.common.util.date.DateUtils;
import cn.zd.cer.framework.pay.config.ZdPayAutoConfiguration;
import cn.zd.cer.framework.pay.core.enums.PayChannelEnum;
...
@Import({PayOrderServiceImpl.class, PayAppServiceImpl.class,
        PayChannelServiceImpl.class, ZdPayAutoConfiguration.class})
