package cn.zd.cer.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "cn.zd.cer.adminserver.UserController.save(...)")
