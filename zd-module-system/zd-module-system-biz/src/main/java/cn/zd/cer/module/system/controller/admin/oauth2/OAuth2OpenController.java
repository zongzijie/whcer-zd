...
import cn.zd.cer.framework.common.util.http.HttpUtils;
...
import cn.zd.cer.module.system.convert.oauth2.OAuth2OpenConvert;
...
import cn.zd.cer.module.system.util.oauth2.OAuth2Utils;
...
import static cn.zd.cer.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.zd.cer.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static cn.zd.cer.framework.common.pojo.CommonResult.success;
import static cn.zd.cer.framework.common.util.collection.CollectionUtils.convertList;
