package cn.zd.cer.module.system.service.social;
...
import cn.zd.cer.module.system.dal.dataobject.social.SocialUserBindDO;
import cn.zd.cer.module.system.dal.dataobject.social.SocialUserDO;
import cn.zd.cer.module.system.dal.mysql.social.SocialUserBindMapper;
import cn.zd.cer.module.system.dal.mysql.social.SocialUserMapper;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 ZdAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private ZdAuthRequestFactory zdAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = zdAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
