...
import cn.zd.cer.framework.datapermission.core.util.DataPermissionUtils;
...
import cn.zd.cer.module.system.convert.user.UserConvert;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:zdyuanma}")
