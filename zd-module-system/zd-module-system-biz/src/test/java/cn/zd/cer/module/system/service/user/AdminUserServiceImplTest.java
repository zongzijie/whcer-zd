package cn.zd.cer.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import cn.zd.cer.framework.common.enums.CommonStatusEnum;
import cn.zd.cer.framework.common.exception.ServiceException;
import cn.zd.cer.framework.common.pojo.PageResult;
import cn.zd.cer.framework.common.util.collection.ArrayUtils;
import cn.zd.cer.framework.common.util.collection.CollectionUtils;
import cn.zd.cer.framework.test.core.ut.BaseDbUnitTest;
import cn.zd.cer.module.infra.api.file.FileApi;
import cn.zd.cer.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import cn.zd.cer.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import cn.zd.cer.module.system.controller.admin.user.vo.user.*;
import cn.zd.cer.module.system.dal.dataobject.dept.DeptDO;
import cn.zd.cer.module.system.dal.dataobject.dept.PostDO;
import cn.zd.cer.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.zd.cer.module.system.dal.mysql.dept.UserPostMapper;
import cn.zd.cer.module.system.dal.mysql.user.AdminUserMapper;
import cn.zd.cer.module.system.enums.common.SexEnum;
import cn.zd.cer.module.system.service.dept.DeptService;
import cn.zd.cer.module.system.service.dept.PostService;
import cn.zd.cer.module.system.service.permission.PermissionService;
import cn.zd.cer.module.system.service.tenant.TenantService;
...
import static cn.zd.cer.framework.common.util.collection.SetUtils.asSet;
...
import static cn.zd.cer.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("zdyuanma");
        ...
        assertEquals("zdyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("zdyuanma"))).thenReturn("java");
